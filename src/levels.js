...
// =============================================================================
const L1_floor = row(
  // S1 0-25 — в конце S1+начало S2 слипались в пропасть 10 тайлов, добавлен
  // островок e(2) в середине, чтобы оба прыжка были по 4 тайла (max 6 на dy=0).
  e(4),  d(6),  s(3),  d(1),  e(7),  d(4),  e(2),  d(4),
  // S2 26-51
  e(8),  d(3),  s(2),  d(3),  e(5),  d(4),
  // S3 52-77
  e(20), "F",   d(1)
);
const L1 = {
  ...
  enemies: [
    { x: 16, y: 6, patrol: [14, 20] },
    { x: 35, y: 6, patrol: [31, 38] },
  ],
  movingPlatforms: [],
};
